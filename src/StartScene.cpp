...
void StartScene::start()
{
	...
	m_pNameLabel1 = new Label("Andrew Boulanger - 101 292 574", "Consolas", 32, blue, glm::vec2(400.0f, 120.0f));
	...
	m_pInstructionsLabel = new Label("press start button to Play", "Consolas", 40, blue, glm::vec2(400.0f, 500.0f));
